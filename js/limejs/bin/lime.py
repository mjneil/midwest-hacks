...
def update():
    ...
    call = '/c/python33/python.exe' + escapeSpace(os.path.join(closure_dir,'closure/bin/build/depswriter.py'))+' --root_with_prefix="'+\
...
def build(name,options):
    ...
    call = '/c/python33/python.exe' + escapeSpace(os.path.join(closure_dir,'closure/bin/build/closurebuilder.py'))+' '+opt+' --namespace="'+name+'" '+\
